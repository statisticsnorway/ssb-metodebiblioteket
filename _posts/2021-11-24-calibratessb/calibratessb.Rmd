...
title: "CalibrateSSB"
description: |
  Functions to calculate weights, estimates of changes and corresponding variance estimates for panel data with non-response. Partially overlapping samples are handled. Initially, weights are calculated by linear calibration.
author:
  - name: CalibrateSSB
    url: https://cran.r-project.org/web/packages/CalibrateSSB/index.html
date: 2021-11-24
output:
...
categories:
  ...
  - estimation
---
### 1. Examples of using CalibrateSSB
...
b <- CalibrateSSB(z, popTotals=a$popTotals, 
                  calmodel="~ sex*age", 
                  partition = c("year","q"), 
                  usePackage = "none", 
