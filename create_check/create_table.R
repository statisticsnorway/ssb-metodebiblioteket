...
add_func('ThError', 'Kostra', keyword = "r kontrollere fordeling")
add_func('Hb', 'Kostra', keyword = "r kontrollere fordeling")
add_func('Quartile', 'Kostra', keyword = "r kontrollere fordeling")
add_func('OutlierRegressionMicro', 'Kostra', keyword = "r kontrollere innflytelse")
add_func('Rank2NumVar', 'Kostra', keyword = "r kontrollere fordeling" )
add_func("Diff2NumVar", "Kostra", keyword = "r kontrollere fordeling" )
add_func("AggrSml2NumVar", "Kostra", keyword = "r kontrollere fordeling" )
add_func("get_extremes", "struktuR", keyword = "r kontrollere innflytelse" )
